...
public class PermissionsActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_PERMISSIONS = "com.test.camera.EXTRA_PERMISSIONS";
    private static final String PACKAGE_URL_SCHEME = "package:";

    private com.test.permission.PermissionsChecker checker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checker = new com.test.permission.PermissionsChecker(this);
        requiresCheck = true;
    }
